...
void main() {
  group('BarChartRenderer', () {
    ...
    final renderBarChart =
        RenderBarChart(mockBuildContext, data, targetData, 1, false, null);
    ...
    test('test 1 correct data set', () {
      ...
      expect(renderBarChart.paintHolder.textScale == textScaler, true);
    });
    ...
    test('test 2 check paint function', () {
      ...
      expect(paintHolder.textScale, textScaler);
